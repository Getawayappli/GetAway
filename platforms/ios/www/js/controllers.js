...
//Accueil
.controller('accueilCtrl', function($scope,$state,$ionicPopover,$timeout,ionicMaterialMotion,ionicMaterialInk,Items,Event,Interet) {
  ...
  var quaryref=ref.orderByChild("date").limitToLast(nbevent);
